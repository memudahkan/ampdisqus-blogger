...
function loadtoc(a) {
    ...
    b();
    displayToc2();
    document.write('<br/><a style="display:none" href="http://www.abu-farhan.com" style="font-size: 8px; text-decoration:none; color: #616469;">Widget by Abu Farhan</a></br/>')
}
...
function displayToc2() {
    ...
    while (b < postTitle.length) {
        ...
        document.write("<p/>");
        document.write('<p class="judul"><a href="' + postYearMonth2[b] + '">' + temp1 + "</a></p><ul>");
        firsti = a;
        do {
            document.write("<li>");
